>MongoDB作为最流行的NoSQL数据库已经火了好几年了，可是一直没有时间尝试，正好我的项目里刚好有类似公告配置、帮助中心配置的需求，类似这样的关系性不强的、对事务要求不高的数据存储应该比较适合NoSQL，所以趁此机会尝试一下MongoDB。目前看到配置文件，网上搜到的都不是很全或者比较旧，所以我看着官方文档配置的，顺便做下简单的翻译注释。如有不对的地方，请在评论告知，谢谢。
